            ...
            <div class="col-md-9 aside">
                ...
                <?php if(!empty($products)): ?>
                    ...
                    <div class="info-block">
                        <p>Поиск товаров по Вашему запросу: <?=$query?></p>
                    </div>
                    <!-- Categories Info -->
                                            ...
                                            <div class="carousel-inside slide" data-ride="carousel">
                                                <div class="carousel-inner" role="listbox">
                                                    <div class="item active">
                                                        <a href="product/<?=$product->alias?>"><img class="product-image-photo" src="<?=PRODUCTIMG.$product->img?>" alt=""></a>
                                                    </div>
                                                    <div class="item">
                ...
                <?php else: ?>
                    ...
                    <h2>В категории  ещё нет товаров </h2>
                <?php endif; ?>
                <!-- Banners
                <div class="row">
                    <div class="col-sm-6">

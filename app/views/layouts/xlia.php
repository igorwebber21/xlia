...
<head>
    ...
    <meta name="description" content="Интернет-магазин женской одежды LiOR. Стильная и модная женская одежда для девушек ❤ Доставка в любой уголок ✈ Планеты. Скидки постоянным клиентам✔">
                        ...
                        <div class="header__column header__column--left header__column--side">
                            <div class="header__section header__section--search">
                                ...
                                <script type="text/javascript">
                                  init_search_widget('#f552bddb4c9a90c2f284810aeb048dc7', {
                                    hideQuery: true
                                  });
                                </script>
                            </div>
                        ...
                        <div class="header__column header__column--right header__column--side">
                                        ...
                                        <div class="popup-body j-text">
                                            ...
                                            <form method="post" action="/_widget/contacts/submit-callback/">
                                                <dl class="form">
                                                    ...
                                                    <dd class="form-item">
                                                        <input type="text" value="Сэм" class="field j-focus" name="form[title]">
                                                    </dd>
                                                ...
                                                <script>
                                                  (function($) {
                                                      var i = $('<input>').attr({
                                                        name: "CSRFToken",
                                                        type: 'hidden'
                                                      }).val("ef220183946749b0084f231a973b50aa9f062da3");
                                                      $("#call-me form:first").append(i);
                                                    }
                                                  )(jQuery);
                                                </script>
                                            </form>
                            ...
                            <div class="header__section">
                                <div class="basket" data-widget="mini_cart" data-skin="header" data-icon="bag" data-elements="all">
                                    <a class="basket__link" href="#" onclick="showModal('__cart')">
                                        <div class="basket__icon basket__icon--bag j-basket-icon">
                                            ...
                                            <div class="basket__items">5</div>
                                        </div>
                                        <div class="basket__contents">
                                            <div class="basket__title">Мой заказ</div>
                                            <div class="basket__value">3 860 грн</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
    ...
    <div class="popup-block login">
        ...
        <div class="login-body">
            <div class="login-tabs-content" id="j-popup-tab-auth">
                <form method="post" id="login_form_id" action="/security/login/" onsubmit="submit_authorization(this); return false;">
                    ...
                    <script>
                      (function($) {
                          var i = $('<input>').attr({
                            name: "CSRFToken",
                            type: 'hidden'
                          }).val("9113aeaea1264fb864f21e429f622637d7b22619");
                          $("#login_form_id").append(i);
                        }
                      )(jQuery);
                    </script>
                </form>
            ...
            <div class="login-tabs-content" id="j-popup-tab-signup">
                <form method="post" id="signup-form" action="/security/sign_up/" onsubmit="submit_new_registration(this); return false;">
                    ...
                    <script>
                      (function($) {
                          var i = $('<input>').attr({
                            name: "CSRFToken",
                            type: 'hidden'
                          }).val("882075cba7f791aa078403d3b82d69068447832b");
                          $("#signup-form").append(i);
                        }
                      )(jQuery);
                    </script>
                </form>
...
<section id="password-recovery" class="popup __password" style="display: none;">
    <div class="popup-block login">
        ...
        <div class="popup-body">
            ...
            <form id="password-recovery-form" method="post" action="/security/password-recovery/" onsubmit="password_recovery_submit(this); return false;">
                <dl class="form">
                    <dt class="form-head">Эл. почта</dt>
                    <dd class="form-item">
                ...
                <script>
                  (function($) {
                      var i = $('<input>').attr({
                        name: "CSRFToken",
                        type: 'hidden'
                      }).val("f41b76a3d42515698186ff63fee775d05ad0a756");
                      $("#password-recovery-form").append(i);
                    }
                  )(jQuery);
                </script>
            </form>
            ...
            <div class="cart">
                <div class="cart-content">
                    <table class="cart-items">
                        ...
                        <tr class="j-cart-product j-remove-container" id="product_0bce62b2368a6fec98fd03f6a4972016">
                            <td class="cart-cell __image">
                                <div class="cart-remove">
                                    <a class="cart-remove-btn j-remove-p" href="#">
                                        <i class="icon-cart-remove"></i>
                                    </a>
                                </div>
                                <div class="cart-image">
                                    <a href="?view=product">
                                        <img width='63' height='78' src='/images/main-2-1-mini.jpg'>
                                    </a>
                                </div>
                            </td>
                            <td class="cart-cell __details">
                                <div class="cart-title">
                                    <a href="/pudrovaya-zamshevaya-ubka-shorty/5888/">Платье </a>
                                </div>
                                <div class="cart-price">990 грн        </div>
                            </td>
                            <td class="cart-cell __quantity">
                                <div class="cart-quantity">
                                    <div class="counter counter--large">
                                        <div class="counter__container">
                                            <button class="counter-btn __minus __disabled j-decrease-p">
                                                <span class="icon-minus"></span>
                                            </button>
                                            <div class="counter-input">
                                                <input class="counter-field j-quantity-p" type="text" value="1" data-step="1" data-min="1" data-max="9223372036854775807">
                                            </div>
                                            <button class="counter-btn __plus j-increase-p">
                            ...
                            <td class="cart-cell __cost">
                                <div class="cart-cost j-sum-p">990 грн</div>
                            </td>
                        </tr>
                        <tr class="j-cart-product j-remove-container" id="product_d13cb877ba547b7ab8b760775a475c0a">
                            <td class="cart-cell __image">
                                <div class="cart-remove">
                                    <a class="cart-remove-btn j-remove-p" href="#">
                                        <i class="icon-cart-remove"></i>
                                ...
                                <div class="cart-image">
                                    <a href="?view=product">
                                        <img width='63' height='78' src='/images/product-1-mini.jpg'>
                                    </a>
                                </div>
                            </td>
                            <td class="cart-cell __details">
                                <div class="cart-title">
                                    <a href="/seryy-kombenizon-so-shnurkom/3786/">Платье 2</a>
                                </div>
                                <div class="cart-price __old">1 450 грн            </div>
                                <div class="cart-price">590 грн        </div>
                            </td>
                            <td class="cart-cell __quantity">
                                <div class="cart-quantity">
                                    <div class="counter counter--large">
                            ...
                            <td class="cart-cell __cost">
                                <div class="cart-cost j-sum-p">590 грн</div>
                            </td>
                        </tr>
                        <tr class="j-cart-product j-remove-container" id="product_1c5b54b569450d1f1b5bc55f8660c5bd">
                            <td class="cart-cell __image">
                                <div class="cart-remove">
                                    <a class="cart-remove-btn j-remove-p" href="#">
                                        <i class="icon-cart-remove"></i>
                                ...
                                <div class="cart-image">
                                    <a href="?view=product">
                                        <img width='50' height='78' src='/images/main-1-1-mini.jpg'>
                                    </a>
                                </div>
                            </td>
                            <td class="cart-cell __details">
                                <div class="cart-title">
                                    <a href="/sviter/5833/">Платье 3</a>
                                </div>
                                <div class="cart-price">1 100 грн        </div>
                            </td>
                            <td class="cart-cell __quantity">
                                <div class="cart-quantity">
                                    <div class="counter counter--large">
                            ...
                            <td class="cart-cell __cost">
                                <div class="cart-cost j-sum-p">1 100 грн</div>
                            </td>
                        </tr>
                        </tbody>
                        ...
                        <tr>
                            <td class="cart-footer" colspan="4">
                                <div class="cart-summary">
                                    ...
                                    <div class="cart-footer-b cart-cost j-total-sum">3 860 грн</div>
                                </div>
                                <div class="cart-buttons">
                                    ...
                                    <div class="cart-btnOrder">
                                        <a class="btn __special" rel="nofollow" href="?view=checkout">
    ...
    <section id="product-try-on" class="popup __productTryOn" style="display: none;">
        <div class="popup-block login">
            ...
            <div class="login-header">
                ...
                <div class="popup-text">Уважаемый покупатель, если Вы из города Одессы, то Вы можете записаться на примерку товара "Платье Джесика". Просто заполните форму ниже, указав удобный для Вас район города. Наш менеджер свяжется с Вами и согласует время и место примерки.</div>
            </div>
            <div class="try-on-body">
                <form method="post" id="signup-form" action="/security/sign_up/" onsubmit="submit_new_registration(this); return false;">
                    ...
                    <dl class="form">
                        ...
                        <dd class="form-item">
                            <select class="select j-ignore j-delivery-type" name="Delivery[delivery_type]" id="changeRegion">
                                <option value="1" data-price="0.00" data-by-carrier="0" selected>Приморский</option>
                                <option value="2" data-price="-1" data-by-carrier="1">Малиновский</option>
                                <option value="3" data-price="-1" data-by-carrier="1">Суворовский</option>
                                <option value="4" data-price="-1" data-by-carrier="1">Киевский</option>
                            </select>
                        </dd>
                        <dd class="form-item __submit">
                                    <span class="btn __special btn-try-on-block">
                                        <span class="btn-content">Записаться на примерку</span>
                                        <input type="submit" value="Зарегистрироваться" class="btn-input btn-try-on" tabindex="7">
                                    </span>
                        </dd>
                    </dl>
                </form>
...
<script type="text/javascript">
  (function() {
      AjaxCart.selector = "#fddd8a5ee53f71d577d4ddd8ca29510f";
